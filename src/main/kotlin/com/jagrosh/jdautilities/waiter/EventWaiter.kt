...
class EventWaiter : EventListener {
    ...
    fun <T : GenericEvent> waitFor(cls: Class<T>, action: Consumer<T>): WaiterBuilder<T> =
        WaiterBuilder(cls) { action.accept(it) }
    ...
    inner class Waiter<in T : GenericEvent>(
        private val cls: Class<in T>,
